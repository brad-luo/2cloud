...
from env import DB_SETTING, SERVER_SETTING
...
if __name__ == '__main__':
    ...
    # mysql db
    db = connect_mysql(**DB_SETTING)
    # start server

    httpd = HTTPServer(SERVER_SETTING, MyHandler)
    print('Server running on {}:{}...'.format(*SERVER_SETTING))
    httpd.serve_forever()
